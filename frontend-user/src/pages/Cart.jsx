                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                        <div className="bg-gray-900 rounded-lg p-6 border border-gray-800 sticky top-24">
                            ...
                            <Button onClick={handleRentAll} className="w-full mb-3 py-3 text-lg">
                                Louer tout ({cart.length} film{cart.length > 1 ? 's' : ''})
                            </Button>
                            <button
                                onClick={clearCart}
                                className="w-full px-4 py-3 border border-gray-700 rounded hover:bg-gray-800 transition text-gray-300"
                            >
                                Vider le panier
                            </button>
                        </div>
